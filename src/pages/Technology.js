...
return<div className="technology">
  ...
  <div className='buttons-technology-switch'>
    <button className={buttonNumber ===1?"switcher-technology active": " switcher-technology" } onClick={()=>
      changeTechnology(technologyContent[0],Vehicle,1)
      }>1</button>
    <button className={buttonNumber ===2?"switcher-technology active": " switcher-technology" } onClick={(e)=> 
      changeTechnology(technologyContent[1],Spaceport,2)
      }
      >2</button>
    <button className={buttonNumber ===3?"switcher-technology active": " switcher-technology" } onClick={()=> changeTechnology(technologyContent[2],Capsule,3)}>3</button>
  </div>
